...
type onRequestCallback = (client: Bun.ServerWebSocket, request: WebSocketApi) => void;
    ...
    websocket: {
      ...
      message(webSocket, message) {
        try {
          ...
          const data = typeof message === 'string' ? message : (message && (message as any).data) ?? message;
